...
module.exports = {
    Status: Status,
    parseJobInfo: parseJobInfo,
    createInternalBuild: createInternalBuild,
    getParallelBuilds: getParallelBuilds,
    fillParentBuilds: fillParentBuilds,
    updateParentBuilds: updateParentBuilds,
    getParentBuildStatus: getParentBuildStatus,
    handleNewBuild: handleNewBuild,
    getFinishedBuilds: getFinishedBuilds,
    createJoinObject: createJoinObject,
    createExternalBuild: createExternalBuild,
    getParentBuildIds: getParentBuildIds,
    strToInt: strToInt,
